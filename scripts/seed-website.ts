...
const projectsData = [
    ...
    {
        titleAr: "معرض الرياض الدولي للسيارات",
        titleEn: "Riyadhh International Auto Show",
        slugAr: "معرض-الرياض-الدولي-للسيارات",
        slugEn: "Riyadhh-international-auto-show",
        imageUrls: ["https://europa-tents.com/wp-content/uploads/2020/07/maa-1.jpeg"],
        descriptionAr: "توفير خيام معارض احترافية لمعرض السيارات الدولي في الرياض، شملت 3 خيام كبيرة بمساحة إجمالية 2000 متر مربع.",
        descriptionEn: "Providing professional exhibition tents for the International Auto Show in Riyadhh, including 3 large tents with a total area of 2000 square meters.",
        keywordsAr: ["معرض", "سيارات", "الرياض"],
        keywordsEn: ["exhibition", "cars", "Riyadhh"],
        tagsAr: ["معرض", "سيارات"],
